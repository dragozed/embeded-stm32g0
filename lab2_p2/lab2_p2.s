...
.section .text
main:
	/* enable GPIOC and GPIOA clock, bit2 on IOPENR */
	ldr r6, =RCC_IOPENR
	ldr r5, [r6]
	...
	//setup PA7 as button input "00: input mode" for bits "14-15"
	ldr r6, =GPIOA_MODER
	ldr r5, [r6]
	movs r4, 0x3
	lsls r4, r4, #18
...
button_ctrl:
	//button control loop branches to led_on or led_off
	ldr r6, =GPIOA_IDR//input data register
	ldr r5, [r6]
	lsrs r5, r5, #9
	movs r4, #0x1
	ands r5, r5, r4
